#############################################################################
# Makefile for building: linux-bin/fmreceiver-1.0
...
CC            = gcc
CXX           = g++
DEFINES       = -DHAVE_DABSTICK -DHAVE_SDRPLAY -DHAVE_AIRSPY -DHAVE_HACKRF -DHAVE_ELAD_S1 -DHAVE_PMSDR -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
INCPATH       = -I. -I. -I.. -I../.. -Iincludes -Iincludes/output -Iincludes/various -Iincludes/fm -Iincludes/rds -Iincludes/scopes-qwt6 -Isrc -Isrc/output -Isrc/various -Isrc/fm -Isrc/rds -Isrc/scopes-qwt6 -Idevices -Idevices/filereader -I../../../../include/qt5/qwt -Idevices/rtlsdr-handler -Idevices/sdrplay-handler -Idevices/airspy -I../../../../local/include/libairspy -Idevices/hackrf-handler -Idevices/sw-elad-s1 -Idevices/pmsdr -I../../../../include/qt5 -I../../../../include/qt5/QtWidgets -I../../../../include/qt5/QtGui -I../../../../include/qt5/QtCore -I. -I../../../../include/libdrm -I. -I../../../../lib64/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = fmreceiver-1.01.0.0
DISTDIR = /usr/shared/sdr-j-development/systems/sdr-j-fm/.tmp/fmreceiver-1.01.0.0
LINK          = g++
LFLAGS        = -flto -Wl,-O1
...
QMAKE_TARGET  = fmreceiver-1.0
DESTDIR       = linux-bin/
TARGET        = linux-bin/fmreceiver-1.0


first: all
####### Build rules

$(TARGET): ui_radio.h ui_filereader-widget.h ui_dabstick-widget.h ui_sdrplay-widget.h ui_airspy-widget.h ui_hackrf-widget.h ui_elad_widget.h ui_pmsdr-widget.h $(OBJECTS)  
...
distdir: FORCE
	...
	$(COPY_FILE) --parents radio.h includes/popup-keypad.h includes/fm-constants.h includes/various/keyboardfilter.h includes/various/program-list.h includes/various/squelchClass.h includes/various/fft.h includes/various/oscillator.h includes/various/ringbuffer.h includes/various/pllC.h includes/various/sincos.h includes/various/newconverter.h includes/various/fir-filters.h includes/various/fft-filters.h includes/various/iir-filters.h includes/various/Xtan2.h includes/output/audiosink.h includes/scopes-qwt6/scope.h includes/scopes-qwt6/spectrogramdata.h includes/scopes-qwt6/fft-scope.h includes/fm/fm-demodulator.h includes/fm/fm-processor.h includes/rds/rds-decoder.h includes/rds/rds-blocksynchronizer.h includes/rds/rds-group.h includes/rds/rds-groupdecoder.h devices/device-handler.h devices/filereader/filereader.h devices/filereader/filehulp.h devices/rtlsdr-handler/rtlsdr-handler.h devices/rtlsdr-handler/dongleselect.h devices/sdrplay-handler/sdrplay-handler.h devices/sdrplay-handler/sdrplayselect.h devices/airspy/airspy-handler.h devices/hackrf-handler/hackrf-handler.h devices/sw-elad-s1/elad-s1.h devices/sw-elad-s1/elad-worker.h devices/sw-elad-s1/elad-loader.h devices/pmsdr/pmsdr.h devices/pmsdr/pmsdr-usb.h devices/pmsdr/pmsdr-comm.h devices/pmsdr/pa-reader.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp radio.cpp src/popup-keypad.cpp src/various/keyboardfilter.cpp src/various/program-list.cpp src/various/fft.cpp src/various/oscillator.cpp src/various/pllC.cpp src/various/sincos.cpp src/various/newconverter.cpp src/various/fir-filters.cpp src/various/fft-filters.cpp src/various/iir-filters.cpp src/various/Xtan2.cpp src/output/audiosink.cpp src/scopes-qwt6/scope.cpp src/scopes-qwt6/fft-scope.cpp src/fm/fm-demodulator.cpp src/fm/fm-processor.cpp src/rds/rds-decoder.cpp src/rds/rds-blocksynchronizer.cpp src/rds/rds-group.cpp src/rds/rds-groupdecoder.cpp devices/device-handler.cpp devices/filereader/filereader.cpp devices/filereader/filehulp.cpp devices/rtlsdr-handler/rtlsdr-handler.cpp devices/rtlsdr-handler/dongleselect.cpp devices/sdrplay-handler/sdrplay-handler.cpp devices/sdrplay-handler/sdrplayselect.cpp devices/airspy/airspy-handler.cpp devices/hackrf-handler/hackrf-handler.cpp devices/sw-elad-s1/elad-s1.cpp devices/sw-elad-s1/elad-worker.cpp devices/sw-elad-s1/elad-loader.cpp devices/pmsdr/pmsdr.cpp devices/pmsdr/pmsdr-usb.cpp devices/pmsdr/pmsdr-comm.cpp devices/pmsdr/pa-reader.cpp $(DISTDIR)/
	$(COPY_FILE) --parents radio.ui devices/filereader/filereader-widget.ui devices/rtlsdr-handler/dabstick-widget.ui devices/sdrplay-handler/sdrplay-widget.ui devices/airspy/airspy-widget.ui devices/hackrf-handler/hackrf-widget.ui devices/sw-elad-s1/elad_widget.ui devices/pmsdr/pmsdr-widget.ui $(DISTDIR)/
...
moc_radio.cpp: includes/fm-constants.h \
		...
		moc_predefs.h \
		../../../../lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/sdr-j-fm -I/usr/shared/sdr-j-development/systems/sdr-j-fm -I/usr/shared/sdr-j-development/systems -I/usr/shared/sdr-j-development -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/output -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/various -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/fm -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/rds -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/scopes-qwt6 -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/output -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/various -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/fm -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/rds -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/scopes-qwt6 -I/usr/shared/sdr-j-development/systems/sdr-j-fm/devices -I/usr/shared/sdr-j-development/systems/sdr-j-fm/devices/filereader -I/usr/include/qt5/qwt -I/usr/shared/sdr-j-development/systems/sdr-j-fm/devices/rtlsdr-handler -I/usr/shared/sdr-j-development/systems/sdr-j-fm/devices/sdrplay-handler -I/usr/shared/sdr-j-development/systems/sdr-j-fm/devices/airspy -I/usr/local/include/libairspy -I/usr/shared/sdr-j-development/systems/sdr-j-fm/devices/hackrf-handler -I/usr/shared/sdr-j-development/systems/sdr-j-fm/devices/sw-elad-s1 -I/usr/shared/sdr-j-development/systems/sdr-j-fm/devices/pmsdr -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/7 -I/usr/include/c++/7/x86_64-redhat-linux -I/usr/include/c++/7/backward -I/usr/lib/gcc/x86_64-redhat-linux/7/include -I/usr/local/include -I/usr/include radio.h -o moc_radio.cpp
...
moc_airspy-handler.cpp: ../../../../include/qt5/QtCore/QObject \
		...
		moc_predefs.h \
		../../../../lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/sdr-j-fm -I/usr/shared/sdr-j-development/systems/sdr-j-fm -I/usr/shared/sdr-j-development/systems -I/usr/shared/sdr-j-development -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/output -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/various -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/fm -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/rds -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/scopes-qwt6 -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/output -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/various -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/fm -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/rds -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/scopes-qwt6 -I/usr/shared/sdr-j-development/systems/sdr-j-fm/devices -I/usr/shared/sdr-j-development/systems/sdr-j-fm/devices/filereader -I/usr/include/qt5/qwt -I/usr/shared/sdr-j-development/systems/sdr-j-fm/devices/rtlsdr-handler -I/usr/shared/sdr-j-development/systems/sdr-j-fm/devices/sdrplay-handler -I/usr/shared/sdr-j-development/systems/sdr-j-fm/devices/airspy -I/usr/local/include/libairspy -I/usr/shared/sdr-j-development/systems/sdr-j-fm/devices/hackrf-handler -I/usr/shared/sdr-j-development/systems/sdr-j-fm/devices/sw-elad-s1 -I/usr/shared/sdr-j-development/systems/sdr-j-fm/devices/pmsdr -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/7 -I/usr/include/c++/7/x86_64-redhat-linux -I/usr/include/c++/7/backward -I/usr/lib/gcc/x86_64-redhat-linux/7/include -I/usr/local/include -I/usr/include devices/airspy/airspy-handler.h -o moc_airspy-handler.cpp
...
compiler_uic_make_all: ui_radio.h ui_filereader-widget.h ui_dabstick-widget.h ui_sdrplay-widget.h ui_airspy-widget.h ui_hackrf-widget.h ui_elad_widget.h ui_pmsdr-widget.h
compiler_uic_clean:
	-$(DEL_FILE) ui_radio.h ui_filereader-widget.h ui_dabstick-widget.h ui_sdrplay-widget.h ui_airspy-widget.h ui_hackrf-widget.h ui_elad_widget.h ui_pmsdr-widget.h
ui_radio.h: radio.ui \
		../../../../lib64/qt5/bin/uic \
		../../../../include/qt5/qwt/qwt_plot.h \
		../../../../include/qt5/qwt/qwt_scale_widget.h \
...
ui_airspy-widget.h: devices/airspy/airspy-widget.ui \
		../../../../lib64/qt5/bin/uic
	/usr/lib64/qt5/bin/uic devices/airspy/airspy-widget.ui -o ui_airspy-widget.h
...
airspy-handler.o: devices/airspy/airspy-handler.cpp devices/airspy/airspy-handler.h \
		../../../../include/qt5/QtCore/QObject \
		../../../../include/qt5/QtCore/qobject.h \
		../../../../include/qt5/QtCore/qobjectdefs.h \
		../../../../include/qt5/QtCore/qnamespace.h \
		...
		../../../../local/include/libairspy/airspy.h \
		../../../../local/include/libairspy/airspy_commands.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o airspy-handler.o devices/airspy/airspy-handler.cpp
