...
CC            = gcc
CXX           = g++
DEFINES       = -DHAVE_DABSTICK -DHAVE_SDRPLAY -DSDRPLAY_LIBRARY_NEW -DHAVE_AIRSPY -DHAVE_ELAD_S1 -DHAVE_PMSDR -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
INCPATH       = -I. -I. -I.. -I../.. -Iincludes -Iincludes/output -Iincludes/various -Iincludes/fm -Iincludes/rds -Iincludes/scopes-qwt6 -Iincludes/various -Isrc -Isrc/output -Isrc/various -Isrc/fm -Isrc/rds -Isrc/scopes-qwt6 -Isrc/various -Iinput -Iinput/filereader -I../../../../include/qt5/qwt -Iinput/dabstick -Iinput/sdrplay -Iinput/airspy -I../../../../local/include/libairspy -Iinput/sw-elad-s1 -Iinput/pmsdr -I../../../../include/qt5 -I../../../../include/qt5/QtWidgets -I../../../../include/qt5/QtGui -I../../../../include/qt5/QtCore -I. -I. -I../../../../lib64/qt5/mkspecs/linux-g++
...
DIST          = ../../../../lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		sdr-j-fmreceiver-099.pro gui.h \
		...
		input/pmsdr/pa-reader.h main.cpp \
		gui.cpp \
		src/various/keyboardfilter.cpp \
		src/various/fft.cpp \
		src/various/oscillator.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents gui.h includes/fm-constants.h includes/various/keyboardfilter.h includes/various/squelchClass.h includes/various/fft.h includes/various/oscillator.h includes/various/ringbuffer.h includes/various/pllC.h includes/various/sincos.h includes/various/resampler.h includes/various/converter.h includes/various/fir-filters.h includes/various/fft-filters.h includes/various/iir-filters.h includes/various/Xtan2.h includes/output/audiosink.h includes/scopes-qwt6/scope.h includes/scopes-qwt6/spectrogramdata.h includes/scopes-qwt6/fft-scope.h includes/fm/fm-demodulator.h includes/fm/fm-processor.h includes/fm/fm-levels.h includes/rds/rds-decoder.h includes/rds/rds-blocksynchronizer.h includes/rds/rds-group.h includes/rds/rds-groupdecoder.h input/virtual-input.h input/filereader/filereader.h input/filereader/filehulp.h input/dabstick/dabstick.h input/dabstick/dongleselect.h input/sdrplay/sdrplay.h input/sdrplay/sdrplay-loader.h input/sdrplay/sdrplay-worker.h input/airspy/airspy-handler.h input/sw-elad-s1/elad-s1.h input/sw-elad-s1/elad-worker.h input/sw-elad-s1/elad-loader.h input/pmsdr/pmsdr.h input/pmsdr/pmsdr-usb.h input/pmsdr/pmsdr-comm.h input/pmsdr/pa-reader.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp gui.cpp src/various/keyboardfilter.cpp src/various/fft.cpp src/various/oscillator.cpp src/various/pllC.cpp src/various/sincos.cpp src/various/resampler.cpp src/various/fir-filters.cpp src/various/fft-filters.cpp src/various/iir-filters.cpp src/various/Xtan2.cpp src/output/audiosink.cpp src/scopes-qwt6/scope.cpp src/scopes-qwt6/fft-scope.cpp src/fm/fm-demodulator.cpp src/fm/fm-processor.cpp src/fm/fm-levels.cpp src/rds/rds-decoder.cpp src/rds/rds-blocksynchronizer.cpp src/rds/rds-group.cpp src/rds/rds-groupdecoder.cpp input/virtual-input.cpp input/filereader/filereader.cpp input/filereader/filehulp.cpp input/dabstick/dabstick.cpp input/dabstick/dongleselect.cpp input/sdrplay/sdrplay.cpp input/sdrplay/sdrplay-loader.cpp input/sdrplay/sdrplay-worker.cpp input/airspy/airspy-handler.cpp input/sw-elad-s1/elad-s1.cpp input/sw-elad-s1/elad-worker.cpp input/sw-elad-s1/elad-loader.cpp input/pmsdr/pmsdr.cpp input/pmsdr/pmsdr-usb.cpp input/pmsdr/pmsdr-comm.cpp input/pmsdr/pa-reader.cpp $(DISTDIR)/
	$(COPY_FILE) --parents sdrgui.ui input/filereader/filereader-widget.ui input/dabstick/dabstick-widget.ui input/sdrplay/sdrplay-widget.ui input/airspy/airspy-widget.ui input/sw-elad-s1/elad_widget.ui input/pmsdr/pmsdr-widget.ui $(DISTDIR)/
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_gui.cpp moc_keyboardfilter.cpp moc_scope.cpp moc_fft-scope.cpp moc_fm-processor.cpp moc_rds-decoder.cpp moc_rds-blocksynchronizer.cpp moc_rds-groupdecoder.cpp moc_virtual-input.cpp moc_filehulp.cpp moc_dabstick.cpp moc_dongleselect.cpp moc_sdrplay.cpp moc_sdrplay-worker.cpp moc_airspy-handler.cpp moc_elad-s1.cpp moc_elad-worker.cpp moc_pmsdr.cpp moc_pmsdr-usb.cpp moc_pa-reader.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_gui.cpp moc_keyboardfilter.cpp moc_scope.cpp moc_fft-scope.cpp moc_fm-processor.cpp moc_rds-decoder.cpp moc_rds-blocksynchronizer.cpp moc_rds-groupdecoder.cpp moc_virtual-input.cpp moc_filehulp.cpp moc_dabstick.cpp moc_dongleselect.cpp moc_sdrplay.cpp moc_sdrplay-worker.cpp moc_airspy-handler.cpp moc_elad-s1.cpp moc_elad-worker.cpp moc_pmsdr.cpp moc_pmsdr-usb.cpp moc_pa-reader.cpp
moc_gui.cpp: includes/fm-constants.h \
		...
		gui.h \
		../../../../lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/sdr-j-fm -I/usr/shared/sdr-j-development/systems/sdr-j-fm -I/usr/shared/sdr-j-development/systems -I/usr/shared/sdr-j-development -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/output -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/various -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/fm -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/rds -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/scopes-qwt6 -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/various -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/output -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/various -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/fm -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/rds -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/scopes-qwt6 -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/various -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/filereader -I/usr/include/qt5/qwt -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/dabstick -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/sdrplay -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/airspy -I/usr/local/include/libairspy -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/sw-elad-s1 -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/pmsdr -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/6.2.1 -I/usr/include/c++/6.2.1/x86_64-redhat-linux -I/usr/include/c++/6.2.1/backward -I/usr/lib/gcc/x86_64-redhat-linux/6.2.1/include -I/usr/local/include -I/usr/include gui.h -o moc_gui.cpp
...
moc_dongleselect.cpp: ../../../../include/qt5/QtWidgets/QDialog \
		...
		input/dabstick/dongleselect.h \
		../../../../lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/sdr-j-fm -I/usr/shared/sdr-j-development/systems/sdr-j-fm -I/usr/shared/sdr-j-development/systems -I/usr/shared/sdr-j-development -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/output -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/various -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/fm -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/rds -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/scopes-qwt6 -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/various -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/output -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/various -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/fm -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/rds -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/scopes-qwt6 -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/various -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/filereader -I/usr/include/qt5/qwt -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/dabstick -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/sdrplay -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/airspy -I/usr/local/include/libairspy -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/sw-elad-s1 -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/pmsdr -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/6.2.1 -I/usr/include/c++/6.2.1/x86_64-redhat-linux -I/usr/include/c++/6.2.1/backward -I/usr/lib/gcc/x86_64-redhat-linux/6.2.1/include -I/usr/local/include -I/usr/include input/dabstick/dongleselect.h -o moc_dongleselect.cpp
...
moc_sdrplay-worker.cpp: ../../../../include/qt5/QtCore/QThread \
		...
		input/sdrplay/sdrplay-worker.h \
		../../../../lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/sdr-j-fm -I/usr/shared/sdr-j-development/systems/sdr-j-fm -I/usr/shared/sdr-j-development/systems -I/usr/shared/sdr-j-development -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/output -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/various -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/fm -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/rds -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/scopes-qwt6 -I/usr/shared/sdr-j-development/systems/sdr-j-fm/includes/various -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/output -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/various -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/fm -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/rds -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/scopes-qwt6 -I/usr/shared/sdr-j-development/systems/sdr-j-fm/src/various -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/filereader -I/usr/include/qt5/qwt -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/dabstick -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/sdrplay -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/airspy -I/usr/local/include/libairspy -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/sw-elad-s1 -I/usr/shared/sdr-j-development/systems/sdr-j-fm/input/pmsdr -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/6.2.1 -I/usr/include/c++/6.2.1/x86_64-redhat-linux -I/usr/include/c++/6.2.1/backward -I/usr/lib/gcc/x86_64-redhat-linux/6.2.1/include -I/usr/local/include -I/usr/include input/sdrplay/sdrplay-worker.h -o moc_sdrplay-worker.cpp
...
ui_dabstick-widget.h: input/dabstick/dabstick-widget.ui \
		../../../../lib64/qt5/bin/uic
	/usr/lib64/qt5/bin/uic input/dabstick/dabstick-widget.ui -o ui_dabstick-widget.h
...
dabstick.o: input/dabstick/dabstick.cpp ../../../../include/qt5/QtCore/QThread \
		../../../../include/qt5/QtCore/qthread.h \
		../../../../include/qt5/QtCore/qobject.h \
		../../../../include/qt5/QtCore/qobjectdefs.h \
		../../../../include/qt5/QtCore/qnamespace.h \
...
dongleselect.o: input/dabstick/dongleselect.cpp input/dabstick/dongleselect.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o dongleselect.o input/dabstick/dongleselect.cpp
...
sdrplay-loader.o: input/sdrplay/sdrplay-loader.cpp input/sdrplay/sdrplay-loader.h \
		includes/fm-constants.h \
		mir_sdr.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o sdrplay-loader.o input/sdrplay/sdrplay-loader.cpp

sdrplay-worker.o: input/sdrplay/sdrplay-worker.cpp includes/fm-constants.h \
		input/sdrplay/sdrplay-worker.h \
		../../../../include/qt5/QtCore/QThread \
		../../../../include/qt5/QtCore/qthread.h \
		../../../../include/qt5/QtCore/qobject.h \
		...
		input/sdrplay/sdrplay-loader.h \
		mir_sdr.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o sdrplay-worker.o input/sdrplay/sdrplay-worker.cpp
